    ...
    <div class="example flex">
      <div>
        ...
        <div class="mb-10">
          ...
          <v-button v-tooltip.right.delay100.oY5="'This is tooltip on the right'" class="ml-4">
        ...
        <div class="mb-10">
          ...
          <v-button v-tooltip.bottom.delay0.oY5="'This tooltip apears instantaneously'" class="ml-4">
            Hover me (no delay)
          </v-button>
        </div>
        <div class="mb-10">
        ...
        <div>
          ...
          <v-button v-tooltip.bottom.delay100.oY5.scale-fade="'This is scale-fade tooltip'" class="ml-4">
            Hover me (scale-fade)
          </v-button>
          <v-button v-tooltip.bottom.delay100.oY5.noanim="'This is nofade tooltip'" class="ml-4">
