<template>
  <h3>Modal</h3>
  <p class="text-xl font-light">Modal dialog component. Has two standard buttons for most applications or provide own in footer slow.</p>
  ...
  setup(props) {
    let reference = ref([
      ...
      },
      {
        ...
        type: "Boolean",
        default: "false",
        description: "Disables primary (Cancel) button",
      },
      {
      ...
      },
      {
        ...
        type: "Boolean",
        default: "false",
        description: "Disables close 'X' button in modal header",
      },
      {
    ...
    let referenceStyles = ref([
      ...
      {
        prop: "style-backdrop",
        description: "Style of backdrop, for example opacity",
      },
    ]);
    ...
    let referenceSlots = ref([
      ...
      {
        slot: "footer",
        description: "Modal footer content. Use this slot to place non standard buttons",
      },
    ]);
