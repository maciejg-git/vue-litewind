<template>
  <h3>Tabs</h3>
  <p class="text-xl font-light">Tabs component</p>
  ...
  <section>
    ...
    <div class="example">
      ...
      >
        ...
        <v-tab name="Another tab" class="p-2">
        ...
        <v-tab name="Another tab" class="p-2">
          <template #name>Tab with icon</template>
        </v-tab>
      </v-tabs>
      <div class="mt-5">
        <label for="">Tabs style: </label>
      ...
      <v-tabs name="tabsMaterial" class="mt-5">
        <v-tab name="Props">
          <div class="mb-2 mt-5">
            <label for="range">fill: </label>
            <select id="range" v-model="example.fill">
