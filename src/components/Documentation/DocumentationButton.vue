<template>
  ...
  <section>
    ...
    <div class="example">
      ...
      <div class="flex items-center gap-4 mt-4">
        <v-button style-button="secondary">Secondary button</v-button>
        <v-button style-button="yellow"><v-icon icon="star" class="b-icon--small mr-2" />Yellow button</v-button>
        <v-button style-button="green"><v-icon icon-type="success" class="b-icon--small mr-2" />Green button</v-button>
        <v-button style-button="red">Red button</v-button>
      </div>
      <div class="flex items-center gap-4 mt-4">
